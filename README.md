...
3. Document pre-processing. Junk in junk out. Use a LLM to tidy up files if they are messy. Curate them up for the best shape for your knowledge base.
4. Query pre-processing: Use an LLM to rewrite your users' questions to make it superior for questioning your knowledge base
...
9. Graph RAG. Span across closely related subjects, try a different database such as Neo4j that's specially designed to store nodes with edges (Trend alert: try improving your meta-data first!!)
